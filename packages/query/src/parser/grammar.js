...
let ParserRules = [
    ...
    {"name": "Expression", "symbols": ["RangeValue"], "postprocess": data => data[0]},
    ...
    {"name": "Range", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "RangeValue", "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "RangeValue", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": data => ({type: 'range', value: [data[2], data[6]], col: data[0].col})},
    {"name": "RangeValue", "symbols": [(lexer.has("text") ? {type: "text"} : text)], "postprocess": data => ({type: 'text', value: data[0].value, col: data[0].col})},
    {"name": "RangeValue", "symbols": ["SimpleValue"], "postprocess": data => data[0]},
    {"name": "Value", "symbols": [(lexer.has("text") ? {type: "text"} : text)], "postprocess": data => ({type: 'text', value: data[0].value, col: data[0].col})},
    {"name": "Value", "symbols": ["ColonValue"], "postprocess": data => data[0]},
    {"name": "ColonValue", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), (lexer.has("colon") ? {type: "colon"} : colon), "ColonValue"], "postprocess": data => ({type: 'value', value: `${data[0]}${data[1].value}${data[2].value}`, col: data[0].col})},
    {"name": "ColonValue", "symbols": [(lexer.has("slash") ? {type: "slash"} : slash), "ColonValue"], "postprocess": data => ({type: 'value', value: `${data[0].value}${data[1].value}`, col: data[0].col})},
    {"name": "ColonValue", "symbols": ["SimpleValue"], "postprocess": data => data[0]},
    {"name": "SimpleValue", "symbols": [(lexer.has("slash") ? {type: "slash"} : slash), "SimpleValue"], "postprocess": data => ({type: 'value', value: `${data[0].value}${data[1].value}`, col: data[0].col})},
    {"name": "SimpleValue", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), "SimpleValue"], "postprocess": data => ({type: 'value', value: `${data[0].value}${data[1].value}`, col: data[0].col})},
    {"name": "SimpleValue", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": data => ({type: 'value', value: data[0].value, col: data[0].col})},
    {"name": "SimpleValue", "symbols": [(lexer.has("value") ? {type: "value"} : value)], "postprocess": data => ({type: 'value', value: `${data[0]}`, col: data[0].col})},
