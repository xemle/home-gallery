...
var grammar = {
    ...
    {"name": "SortBy", "symbols": [(lexer.has("sortBy") ? {type: "sortBy"} : sortBy), "_", (lexer.has("value") ? {type: "value"} : value)], "postprocess": data => { return {type: 'sortKey', value: data[2].value, col: data[0].col } }},
    ...
    {"name": "OrExpression", "symbols": ["OrExpression", "__", (lexer.has("or") ? {type: "or"} : or), "_", "AndExpression"], "postprocess": data => { return {type: 'or', left: data[0], right: data[4], col: data[0].col} }},
    {"name": "OrExpression", "symbols": ["AndExpression"], "postprocess": data => data[0]},
    {"name": "AndExpression", "symbols": ["AndExpression", "__", (lexer.has("and") ? {type: "and"} : and), "_", "NotExpression"], "postprocess": data => { return {type: 'and', left: data[0], right: data[4], col: data[0].col} }},
    {"name": "AndExpression", "symbols": ["NotExpression"], "postprocess": data => data[0]},
    {"name": "NotExpression", "symbols": [(lexer.has("not") ? {type: "not"} : not), "_", "NotExpression"], "postprocess": data => { return {type: 'not', value: data[2], col: data[0].col} }},
    ...
    {"name": "KeyValue", "symbols": ["ListExpression"], "postprocess": data => data[0]},
    ...
    {"name": "ListExpression", "symbols": [(lexer.has("value") ? {type: "value"} : value), "__", (lexer.has("inOp") ? {type: "inOp"} : inOp), "_", "ListValues"], "postprocess": data => { return {type: 'in', key: data[0].value, value: data[4], col: data[0].col} }},
    {"name": "ListValues", "symbols": ["Range"], "postprocess": data => { return {type: 'range', from: data[0][0], to: data[0][1]} }},
    {"name": "ListValues", "symbols": ["List"], "postprocess": data => { return {type: 'list', value: data[0]} }},
