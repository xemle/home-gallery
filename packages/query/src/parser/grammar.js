...
var grammar = {
    ...
    {"name": "Query", "symbols": ["Terms"], "postprocess": data => ({type: 'query', value: data[0], orderBy: false})},
    {"name": "OrderExpression", "symbols": ["OrderBy", "__", "Order"], "postprocess": data => ({type: data[2].type, value: data[2].value, direction: false, col: data[0].col})},
    {"name": "OrderExpression", "symbols": ["OrderBy", "__", "Order", "__", "OrderDirection"], "postprocess": data => ({type: data[2].type, value: data[2].value, direction: data[4], col: data[0].col})},
    {"name": "OrderBy", "symbols": [(lexer.has("order") ? {type: "order"} : order), "_", (lexer.has("by") ? {type: "by"} : by)]},
    {"name": "OrderBy", "symbols": [(lexer.has("ORDER") ? {type: "ORDER"} : ORDER), "_", (lexer.has("BY") ? {type: "BY"} : BY)]},
    {"name": "Order", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": data => ({type: 'sortKey', value: data[0].value, col: data[0].col})},
    {"name": "Order$subexpression$1", "symbols": [(lexer.has("count") ? {type: "count"} : count)]},
    {"name": "Order$subexpression$1", "symbols": [(lexer.has("COUNT") ? {type: "COUNT"} : COUNT)]},
    {"name": "Order", "symbols": ["Order$subexpression$1", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("identifier") ? {type: "identifier"} : identifier), "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": data => ({type: 'countSortFn', value: data[4].value, col: data[0].col})},
    ...
    {"name": "OrderDirection$subexpression$1", "symbols": [(lexer.has("DESC") ? {type: "DESC"} : DESC)]},
    {"name": "OrderDirection", "symbols": ["OrderDirection$subexpression$1"], "postprocess": data => data[0][0].value.toLowerCase()},
    ...
    {"name": "NotExpression$subexpression$1", "symbols": [(lexer.has("NOT") ? {type: "NOT"} : NOT)]},
    {"name": "NotExpression", "symbols": ["NotExpression$subexpression$1", "__", "NotExpression"], "postprocess": data => ({type: 'not', value: data[2], col: data[0].col})},
    {"name": "NotExpression$subexpression$2", "symbols": [(lexer.has("not") ? {type: "not"} : not)]},
    {"name": "NotExpression$subexpression$2", "symbols": [(lexer.has("NOT") ? {type: "NOT"} : NOT)]},
    {"name": "NotExpression", "symbols": ["NotExpression$subexpression$2", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "Terms", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": data => ({type: 'not', value: data[4], col: data[0].col })},
    ...
    {"name": "CmpFunction$subexpression$1", "symbols": [(lexer.has("COUNT") ? {type: "COUNT"} : COUNT)]},
    {"name": "CmpFunction", "symbols": ["CmpFunction$subexpression$1"], "postprocess": data => ({type: 'countFn', value: 'count', col: data[0].col})},
    {"name": "ExistsFunction$subexpression$1", "symbols": [(lexer.has("exists") ? {type: "exists"} : exists)]},
    {"name": "ExistsFunction$subexpression$1", "symbols": [(lexer.has("EXISTS") ? {type: "EXISTS"} : EXISTS)]},
    {"name": "ExistsFunction", "symbols": ["ExistsFunction$subexpression$1"], "postprocess": data => ({type: 'existsFn', value: 'has', col: data[0].col})},
    ...
    {"name": "Comparator", "symbols": ["Comparator$subexpression$1"], "postprocess": data => ({ type: 'comp', value: data[0][0].value, col: data[0].col })},
    ...
    {"name": "ComboundChar", "symbols": ["ComboundChar$subexpression$1"], "postprocess": data => ({type: 'compoundChar', value: data[0][0].value, col: data[0].col})},
