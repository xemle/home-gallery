...
* Export file "app.css" exists
* Export file "App.js" exists
* Export file "api/database" exists
* Export file "api/database.gz" exists
* Export file "fonts/fa-regular-400.ttf" exists
