...
function videoFrames(storageDir, frameCount, previewImageSizes) {
  ...
  function extractFrames(entry, cb) {
    ...
    const filename = path.join(dir, `${prefix}-video-frame-001.png`);
